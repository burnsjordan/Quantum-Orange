...
test_algo(one_gate_test, i_test, train_functions.train_monte_carlo(one_gate_test, i_test, gates_list), learning_functions.monte_carlo_algo, 'one_gate_test: ')
test_algo(five_gate_test, i_test, train_functions.train_monte_carlo(five_gate_test, i_test, gates_list), learning_functions.monte_carlo_algo, 'five_gate_test: ')
